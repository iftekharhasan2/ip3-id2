    ...
    <section id="testimonials" className="w-full py-24 sm:py-28 lg:py-32 bg-[var(--bg)] text-[var(--white)] overflow-hidden border-t border-[var(--border)] relative transition-colors duration-250">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-8 sm:mb-12 relative z-20">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#ff7e67]/10 border border-[#ff7e67]/30 text-[#ff7e67] text-xs font-mono font-bold uppercase tracking-widest shadow-xs">
            <span>{sectionData.sectionBadge || "Institutional Endorsements"}</span>
          </div>
